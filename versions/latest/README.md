...
This Docker image provides PaperMC latest Minecraft Server. You can easily run a Minecraft server using this image.
...
```bash
docker build -t endkind/papermc:latest .
```
